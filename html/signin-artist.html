    ...
    <div class="login-block-wrapper" id="login-block-wrapper" onclick="exitlogin(event)">
        <div class="login-block" id="login-block">
            ...
            <div class="login-block-elements">
                <a href="../html/signin-artist.html"><button>Artist Portal</button></a>
                <a href="../html/signin-customer.html"><button>Customer Portal</button></a>
            </div>
        </div>
    </div>
        ...
        <div class="inside-box">
            ...
            <div class="signup-form">
                <form action="" class="form signupp signupform" , method="post">
                    ...
                    <div class="input">
                        <input type="email" name="artistemail" id="artist-email" placeholder="Email" required><span
                            id="email-error-area" style="color:red; font-size: medium;"></span>
                    </div>
                    <div class="input">
                        <input type="text" name="artistphone" id="artist-phone" placeholder="Phone Number"
                            autocomplete="off" required><span id="phone-error-area"
                            style="color:red; font-size: medium;"></span>
                    </div>
                    <div class="input">
                        <input type="text" name="artistaddress" id="artist-address"
                            placeholder="Address(Tole, Ward_no, District)" autocomplete="off" required><span
                    ...
                    <div class="input">
                        <input type="password" name="confirmartistpass" id="confirm-artist-pass"
                    ...
                    <div class="input citizenship">
                        <span>Citizenship Front : <span>*</span></span><input type="file" name="citizenshipFront"
                            id="citizenship-Front" required><span id="citizenship_front-error-area"
                            style="color:red; font-size: medium;"></span>
                    </div>
                    <div class="input citizenship">
                        <span>Citizenship Back :<span>*</span></span><input type="file" name="citizenshipBack"
                            id="citizenship-back" required><span id="citizenship_back-error-area"
                            style="color:red; font-size: medium;"></span>
                    </div>
                ...
                <form action="" class="form loginn" , method="post">
                    ...
                    <div class="input">
                        <input type="password" name="confirmartistpass" id="login-artist-pass" placeholder="Password"
                            autocomplete="off" required>
                    </div>
